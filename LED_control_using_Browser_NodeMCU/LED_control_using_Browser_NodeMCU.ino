...
const char* ssid = "shubham-divice"; // SSID i.e. Service Set Identifier is the name of your WIFI
const char* password = "1dba54bd9293a"; // Your Wifi password, in case you have open network comment the whole statement.
 
int ledPin = D5; // GPIO13 or for NodeMCU you can directly write D7 
